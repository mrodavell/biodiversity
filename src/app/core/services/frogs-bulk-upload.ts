...
export interface FrogsUploadData {
...
export const bulkUploadFrogs = async (
  speciesData: FrogsUploadData[]
...
export const batchUploadFrogs = async (
  speciesData: FrogsUploadData[],
  ...
  try {
    ...
    for (let i = 0; i < batches.length; i++) {
      ...
      const result = await bulkUploadFrogs(batch);
      results.push(result);
