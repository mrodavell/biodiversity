...
export interface TreesUploadData {
...
export const bulkUploadTrees = async (
  speciesData: TreesUploadData[]
...
export const batchUploadTrees = async (
  speciesData: TreesUploadData[],
  ...
  try {
    ...
    for (let i = 0; i < batches.length; i++) {
      ...
      const result = await bulkUploadTrees(batch);
      results.push(result);
