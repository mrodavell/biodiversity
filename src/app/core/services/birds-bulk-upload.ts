...
export interface BirdsUploadData {
...
export const bulkUploadBirds = async (
  speciesData: BirdsUploadData[]
...
export const batchUploadBirds = async (
  speciesData: BirdsUploadData[],
  ...
  try {
    ...
    for (let i = 0; i < batches.length; i++) {
      ...
      const result = await bulkUploadBirds(batch);
      results.push(result);
