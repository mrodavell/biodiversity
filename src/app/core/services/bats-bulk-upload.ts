...
export interface BatsUploadData {
...
export const bulkUploadBats = async (
  speciesData: BatsUploadData[]
...
export const batchUploadBats = async (
  speciesData: BatsUploadData[],
  ...
  try {
    ...
    for (let i = 0; i < batches.length; i++) {
      ...
      const result = await bulkUploadBats(batch);
      results.push(result);
