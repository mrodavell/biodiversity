...
export interface DragonFlyUploadData {
...
export const bulkUploadDragonFly = async (
  speciesData: DragonFlyUploadData[]
...
export const batchUploadDragonFly = async (
  speciesData: DragonFlyUploadData[],
  ...
  try {
    ...
    for (let i = 0; i < batches.length; i++) {
      ...
      const result = await bulkUploadDragonFly(batch);
      results.push(result);
