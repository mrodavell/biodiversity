...
export interface MacroInvertsUploadData {
...
export const bulkUploadMacroInverts = async (
  speciesData: MacroInvertsUploadData[]
...
export const batchUploadMacroInverts = async (
  speciesData: MacroInvertsUploadData[],
  ...
  try {
    ...
    for (let i = 0; i < batches.length; i++) {
      ...
      const result = await bulkUploadMacroInverts(batch);
      results.push(result);
