...
export interface DamselFlyUploadData {
...
export const bulkUploadDamselFly = async (
  speciesData: DamselFlyUploadData[]
...
export const batchUploadDamselFly = async (
  speciesData: DamselFlyUploadData[],
  ...
  try {
    ...
    for (let i = 0; i < batches.length; i++) {
      ...
      const result = await bulkUploadDamselFly(batch);
      results.push(result);
